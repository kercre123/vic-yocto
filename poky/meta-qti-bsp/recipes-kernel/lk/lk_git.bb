...
EXTRA_OEMAKE_append = " ${@oe.utils.conditional('USER_BUILD', '1', 'TARGET_BUILD_VARIANT=user', '', d)}"
...
#enable hardfloat
EXTRA_OEMAKE_append = " ${@oe.utils.conditional('ARM_FLOAT_ABI', 'hard', 'ENABLE_HARD_FPU=1', '', d)}"
