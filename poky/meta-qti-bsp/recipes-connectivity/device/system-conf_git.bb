...
EXTRA_OECONF_remove = "${@oe.utils.conditional('BASEPRODUCT', 'drone', '--enable-pronto-wlan=yes', '', d)}"
EXTRA_OECONF += "${@oe.utils.conditional('BASEPRODUCT', 'drone', '--enable-drone-wlan=yes', '', d)}"
EXTRA_OECONF_remove = "${@oe.utils.conditional('BASEPRODUCT', 'qsap', '--enable-pronto-wlan=yes', '', d)}"
...
EXTRA_OECONF_remove = "${@oe.utils.conditional('PRODUCT', 'robot-rome', '--enable-pronto-wlan=yes', '', d)}"
