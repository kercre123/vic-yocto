...
LLVM_PREBUILTS_PATH := ${LE_LLVM_TOOLCHAIN_PATH}
LLVM_PREBUILTS_HEADER_PATH :=
...
CLANG_CONFIG_TARGET_EXTRA_CPPFLAGS := -I ${TARGET_SYSROOT}/usr/include/c++/4.9.3/
CLANG_CONFIG_TARGET_EXTRA_CPPFLAGS += -I ${TARGET_SYSROOT}/usr/include/c++/4.9.3/${LE_TRIPLE}/
CLANG_CONFIG_TARGET_EXTRA_CPPFLAGS += -I ${TARGET_SYSROOT}/usr/include
endif
# HOST config
