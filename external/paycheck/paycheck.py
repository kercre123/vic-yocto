...
def ParseArguments(argv):
  ...
  trace_opts.add_option('--do-not-truncate-to-expected-size', action='store_true',
                        default=False,
                        help=('Do not try to truncate partition when done applying delta'))
  ...
  with open(payload_file_name) as payload_file:
    ...
    try:
      ...
      if extra_args:
        ...
        if options.do_not_truncate_to_expected_size:
          dargs['truncate_to_expected_size'] = False
